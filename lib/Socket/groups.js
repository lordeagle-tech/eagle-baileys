...
export const makeGroupsSocket = config => {
    ...
    const result = await groupQuery(jid, 'set', [{
      ...
      content: [{
        ...
        content: participants.map(p => ({
          tag: 'participant',
          attrs: {
            jid: typeof p === 'string' ? p : p?.id || p?.jid
          }
        }))
      }]
    }]);
  ...
  return {
    ...
    groupParticipantsAdd: (jid, participants) => groupParticipantsUpdate(jid, participants, 'add'),
    groupParticipantsRemove: (jid, participants) => groupParticipantsUpdate(jid, participants, 'remove'),
    groupParticipantsPromote: (jid, participants) => groupParticipantsUpdate(jid, participants, 'promote'),
    groupParticipantsDemote: (jid, participants) => groupParticipantsUpdate(jid, participants, 'demote'),
    groupParticipantsApprove: (jid, participants) => groupRequestParticipantsUpdate(jid, participants, 'approve'),
    groupParticipantsReject: (jid, participants) => groupRequestParticipantsUpdate(jid, participants, 'reject'),
